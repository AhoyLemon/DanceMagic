  ...
  <body>
    ...
    <header>
      ...
      <div class="inner desktop-only">
        <nav>
          <a href="<?php echo $site->url(); ?>/classes">classes</a>
          | 
          <a href="<?php echo $site->url(); ?>/events">events</a>
          | 
          <a href="<?php echo $site->url(); ?>/about">about us</a>
          | 
          <a href="<?php echo $site->url(); ?>/blogs">blog</a>
          | 
      ...
      <nav class="sidebar mobile-only">
        <a href="<?php echo $site->url(); ?>/classes">classes</a>
        <a href="<?php echo $site->url(); ?>/events">events</a>
        <a href="<?php echo $site->url(); ?>/about">about us</a>
        <a href="<?php echo $site->url(); ?>/blogs">blog</a>
        <a href="<?php echo $site->url(); ?>/contact">contact</a>
        <a href="https://app.jackrabbitclass.com/portal/ppLogin.asp?id=505314">log in</a>
      </nav>
    </header>