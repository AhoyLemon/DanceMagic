    <footer>
      <div class="inner">
        <section>
          <a href="https://www.google.com/maps/place/Dance-N-Magic/@44.9467784,-93.1409836,17z" class="address">
            <img src="<?php echo $site->url(); ?>/assets/svg/gmap.svg" class="logo">
            <address>
              <span>Dance N Magic</span>
              <span>913 Selby Ave</span>
              <span>St. Paul, MN 55104</span>
            </address>
          </a>
        </section>
        <section class="contact email">
          <a href="mailto:info@dance-n-magic.com" class="email">
            ...
            <span>info@dance-n-magic.com</span>
          </a>
        </section>
        <section class="contact phone">
          <a href="tel:651-688-3448" class="phone">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            ...
            <span>(651) 688-3448</span>
          </a>
        </section>
        <section class="social">
          <a href="https://www.facebook.com/pages/Dance-N-Magic/224263814671" class="facebook">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
          ...
          <a href="http://instagram.com/dancenmagic/" class="instagram">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
